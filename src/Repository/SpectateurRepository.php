 ...
 */
class SpectateurRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Spectateur $entity, bool $flush = false): void
    {
    ...
    public function remove(Spectateur $entity, bool $flush = false): void
    {
